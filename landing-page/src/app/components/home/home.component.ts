...
@Component({
  ...
  imports: [HeaderComponent, NgOptimizedImage, BtnPrimaryComponent, NewsletterFormComponent], // importar outros módulos ou componentes que este componente pode usar.
